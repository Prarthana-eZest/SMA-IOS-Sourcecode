...
class FootfallViewController: UIViewController, FootfallDisplayLogic
{
    ...
    func getTotalFootfallGraphEntry(forData data:[Dashboard.GetRevenueDashboard.Revenue_transaction]? = nil, dateRange:DateRange, dateRangeType: DateRangeType) -> GraphDataEntry
    {
        let units = xAxisUnits(forDateRange: dateRange, rangeType: dateRangeType)
    ...
    func totalFootfallGraphData(forData data:[Dashboard.GetRevenueDashboard.Revenue_transaction]? = nil, dateRange:DateRange, dateRangeType: DateRangeType) -> [Double]
    {
...
//        headerModel?.value = footfallCount
        headerModel =  EarningsHeaderDataModel(earningsType: .Footfall, value: footfallCount, isExpanded: false, dateRangeType: graphRangeType, customeDateRange: footfallCutomeDateRange)
    ...
    func calculateHomeService(filterArray: [Dashboard.GetRevenueDashboard.Revenue_transaction], invoiceNumbers: [String], dateRange: DateRange, dateRangeType: DateRangeType) -> [Double]{
        var values = [Double]()
    ...
    func calculateRetailProduct(filterArray: [Dashboard.GetRevenueDashboard.Revenue_transaction], invoiceNumbers: [String], dateRange: DateRange, dateRangeType: DateRangeType) -> [Double]{
        var values = [Double]()
...
extension FootfallViewController: UITableViewDelegate, UITableViewDataSource {
