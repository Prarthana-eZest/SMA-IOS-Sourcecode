...
enum UserDefauiltsKeys {
    ...
    static let k_Key_SelectedLocationFor = "k_Key_SelectedLocationFor"
    // In case value for this Key is "Any"
    //:-- User is coming From Home Tab for user location Or For Data Filter as per location selected
